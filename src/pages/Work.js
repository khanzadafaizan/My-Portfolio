...
function Work() {
  const projects = [{id:"1", title:"Paysa", description:"Developed this project with React.js, using Bootstrap and custom CSS. I converted the design from Figma to React.js, implementing routing, components, props, and conditional rendering while optimizing the code for improved performance and user interaction, ensuring the design remained consistent across all platforms.", image:require("../images/projects/dashborad.png"), gitHub:"https://github.com/khanzadafaizan/Paysa", projectLink:"https://paysa-three.vercel.app/dashborad"},
    {id:"2", title:"Uppcar", description:"Developed this project with React.js, using Bootstrap and custom CSS. I converted the design from other website to React.js, implementing routing, components, props, and conditional rendering while optimizing the code for improved performance and user interaction, ensuring the design remained consistent across all platforms.", image:require("../images/projects/uppcar.jpg"), gitHub:"https://github.com/khanzadafaizan/Uppcar", projectLink:"https://uppcar-nn7e.vercel.app"},
    {id:"3", title:"Coral", description:"This project was built using Next.js and Tailwind CSS, integrating a GraphQL API to create an e-commerce-style website. The focus was on improving performance and user experience, using Next.js for fast rendering.", image:require("../images/projects/coral.jpg"), gitHub:"https://github.com/khanzadafaizan/Nextjs-Ecommerce-Store", projectLink:"https://nextjs-ecommerce-store-1qgb.vercel.app/?tag=fries"},
